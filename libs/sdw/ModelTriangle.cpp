...
ModelTriangle::ModelTriangle(const glm::vec3 &v0, const glm::vec3 &v1, const glm::vec3 &v2, Colour trigColour) :
		vertices({{v0, v1, v2}}), texturePoints(), colour(std::move(trigColour)), isTexture(0), normal() {}

ModelTriangle::ModelTriangle(const glm::vec3 &v0, const glm::vec3 &v1, const glm::vec3 &v2, std::string textureMapName) :
		vertices({{v0, v1, v2}}), texturePoints(), textureMap(TextureMap(textureMapName)),isTexture(1), normal() {}
